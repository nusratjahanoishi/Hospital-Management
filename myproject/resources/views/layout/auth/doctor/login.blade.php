...
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
            <h2 class="text-2xl font-bold text-center text-gray-700 mb-4">Doctor Login</h2>
            ...
            <p class="text-gray-600 text-sm text-center mt-4">
                Don't have an account? <a href="{{ route('doctor.register') }}" class="text-blue-500 hover:underline">Register</a>
            </p>
        </div>
    </div>
</body>
