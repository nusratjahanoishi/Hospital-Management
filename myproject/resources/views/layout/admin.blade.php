...
<body class="flex">
    ...
    <div class="w-64 bg-blue-900 text-white min-h-screen p-5">
        ...
        <ul>
            ...
            <li class="mb-2">
                <a href="{{ url('/admin/users') }}" class="block py-2 px-4 rounded hover:bg-blue-700">Users</a>
            </li>
            <li class="mb-2">
                <a href="{{ url('/admin/appointments') }}" class="block py-2 px-4 rounded hover:bg-blue-700">Appointments</a>
            </li>
            <li class="mb-2">
    ...
    <div class="flex-1">
        ...
        <div class="bg-white shadow-md py-4 px-6 flex justify-between items-center">
            ...
            <a href="{{ url('/admin/profile') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">My Profile</a>
        </div>
        ...
        <div class="p-6">
            <table>
                <thead>
                    <caption class="mt-2 mb-3"><h2>Admin List</h2></caption>
                    <tr>
                        <th>#SL</th>
                        <th>Name</th>
                        <th>Email</th>
